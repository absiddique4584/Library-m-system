...
<div class="row animated fadeInUp">
    <div class="col-sm-12">
        <h2 style="margin-left: 300px;" class="section-subtitle"><b>All Students Information</b></h2>
        <div class="pull-right"><a href="print-all-students.php" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a></div><br><br>
        <div class="panel">
